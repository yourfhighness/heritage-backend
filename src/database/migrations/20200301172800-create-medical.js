const up = (queryInterface, Sequelize) => queryInterface.createTable('Medicals', {
  ...
  currentDiagnosis: { type: Sequelize.STRING(1000) },
  historyFindings: { type: Sequelize.STRING(1000) },
  specialInstruction: { type: Sequelize.STRING(1000) },
  treatment: { type: Sequelize.STRING(1000) },
